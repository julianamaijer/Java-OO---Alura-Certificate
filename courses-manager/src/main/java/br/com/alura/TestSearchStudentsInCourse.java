...
public class TestSearchStudentsInCourse {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Who is the student with number of enrollment 5617?");
        Student s1 = javaCollections.searchEnrollment(5617);
